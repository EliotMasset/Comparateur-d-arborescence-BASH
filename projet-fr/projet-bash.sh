...
Sidossier ()
{
    if test -d $1                                                            # ||
    then                                                                     # ||
        echo -e "        \033[36m$n\033[0m\033[31m/6\033[0m étapes réussies" # ||
    else                                                                     # ||
        echo  -e "\033[31merreur !\033[0m"                                   # ||
        echo "Le répertoire : " $1 " n'existe pas ou est un fichier"         # ||
...
Sivide ()
{
    ...
    then                                                                     # ||
        ...
        echo  -e "\033[31merreur !\033[0m"                                   # ||
        echo "Le répertoire : " $1 " n'est pas accessible en lecture"        # ||
        exit                                                                 # \/
...
{
    echo -e "\033[33mIl y a donc\033[0m\033[32m $3 \033[0m\033[33mdifférences de $4 dans l'arborescence $1 par rapport à l'arborescence $2\033[0m"

    echo -e "Liste des $4 de l'arborescence $1 et de leurs correspondances dans l'arborescence $2 :" >> $md5
    echo -e "------------------------------------------------------------------------------------------\n\n" >> $md5
    if test $versionComplete -eq 1
    then
        echo -e "\033[31mListe des $4 de l'arborescence $1 et de leurs correspondances dans l'arborescence $2 :\033[0m"
...
{
    echo -e "Liste des $3 de l'arborescence $1 qui n'ont aucunes correspondances dans l'arborescence $2 :" >> $md5
    echo -e "------------------------------------------------------------------------------------------\n\n" >> $md5
    echo -e "\033[31mListe des $3 de l'arborescence $1 qui n'ont aucunes correspondances dans l'arborescence $2 :\033[0m"
    echo -e "\033[31m------------------------------------------------------------------------------------------\033[0m\n\n"
}
...
calculcorrespondance ()
{
    ...
    do                                                                                                                                                # ||
        ...
        do                                                                                                                                            # ||
            ...
            then                                                                                                                                      # ||
                ...
                then                                                                                                                                  # ||
                    if test $versionComplete -eq 1                                                                                                    # ||
                    then                                                                                                                              # ||
                        echo -e "\n\033[33mLe $3" $lignenom "a comme corespondance : \033[0m\n"                                                       # ||
                        echo "
                            <tr><td class=\"rouge\" colspan=\"2\">$lignenom</td></tr>
                        " >> projet-bash-site.html                                                                                                    # ||
                    fi                                                                                                                                # ||
                    echo -e "\nLe $3" $lignenom "a comme corespondance : \n" >> $md5                                                                  # ||
                fi                                                                                                                                    # ||
                unefois=0                                                                                                                             # ||
        ...
        then                                                                                                                                          # ||
            if test $versionComplete -eq 1                                                                                                            # ||
            then                                                                                                                                      # ||
                echo -e "\n\033[33mPour information, il se situe à l'adresse:\033[0m $lignechemin"                                                    # ||
                echo -e "\n\033[33m------------------------------------------------------------------------------------------------------\033[0m"     # ||
            fi                                                                                                                                        # ||
            echo -e "\nPour information, il se situe à l'adresse: $lignechemin" >> $md5                                                               # ||
            echo -e "\n------------------------------------------------------------------------------------------------------" >> $md5                # ||
        fi                                                                                                                                            # ||
...
calculdifference ()
{
    ...
    do                                                                                                                                                                 # ||
        ...
        then                                                                                                                                                           # ||
            ...
            " >> projet-bash-site.html                                                                                                                                 # ||
            echo -e "\n\033[33mempreinte md5:\033[0m $lignemd5 \n\033[33mChemin complet du $4: \033[0m$lignechemin \n\033[33mNom du fichier:\033[0m $lignenom \n"      # ||
            echo -e "\nempreinte md5: $lignemd5 \nChemin complet du $4: $lignechemin \nNom du fichier: $lignenom \n" >> $md5                                           # ||
...
do
    echo -e "\033[32mSouhaitez-vous la version complète du programme \033[0m\033[31m(1=OUI/0=NON)\033[0m\033[32m?\033[0m"
...
do
    ...
    do
       echo -e "\033[32mSouhaitez-vous changer le répertoire de destination de md5.txt :\033[0m\033[33m($PWD)\033[0m\033[31m(1=OUI/0=NON)?\033[0m"
       read Booldestination
    done
    if test $Booldestination -eq 1
    then
        echo -e "\033[31mOù souhaitez-vous enregistrer md5.txt?\033[0m"
        read cheminversmd5
    fi
done
md5="md5.txt"
...
clear
    ...
    echo "Lancement du programme dans :"                                # ||
                                                                        # ||
                                                                        # ||
    ...
    sleep 1                                                             # \/
    echo -e "\033[32m\r Go \033[0m"                                     #Décompte à rebours (optionnel)
...
echo -e "\nVérification des \033[31merreurs\033[0m éventuelles...\n\n"


if test $# -ne 2                                                            # ||                                                                         # ||
then                                                                        # ||                                                                         # ||
    echo -e "\033[32mVeuillez renseigner la première arborescence :\033[0m" # ||                                                                         # ||
    read arbo1                                                              # ||                                                                         # ||
    echo -e "\033[32mVeuillez renseigner la seconde arborescence :\033[0m"  # ||                                                                         # ||
    read arbo2                                                              # ||                                                                         # ||
    echo -e "        \033[36m1\033[0m\033[31m/6\033[0m étapes réussies"     # ||                                                                         # ||
else                                                                        # ||                                                                         # ||
    echo -e "        \033[36m1\033[0m\033[31m/6\033[0m étapes réussies"     # \/                                                                         # ||
...
then                                                                                    # ||                                                             # ||
    echo -e "        \033[36m6\033[0m\033[31m/6\033[0m étapes réussies\n"               # ||                                                             # ||
else                                                                                    # ||                                                             # ||
    echo -e "\033[31mErreur ! \033[0m Arborescence(s) vide(s) détectée(s)"              # ||                                                             # ||
    exit                                                                                # \/                                                             # ||
...
echo -e "\033[32mLe programme peut être lancé correctement.\033[0m"
echo -e "\033[31mInformation\033[0m : Le programme prend bien en charge les espaces\n" 
...
do
    ...
    arret=1
    arret=0
    echo "Lecture des empreintes md5 des fichiers de l'arbo" $i
    ...
    echo "Lecture des empreintes md5 des dossiers"
...
<html lang= \"fr\">
    <head>                   
        ...
        <title>Site Web Projet Bash 2019</title>
    </head>
    
    <body>
        <div id=\"page\">
            <div id=\"header\">
                <h1>Site Web Projet Bash 2019</h1>
                <h2>Voici notre site web vous pouvez trouver le tableau des résultats ci-dessous</h2>
            </div>
            <div id=\"containment\">
                <div id=\"content\">
                    <div class=\"article\">
...
if test $versionComplete -eq 1                                                              # ||
then                                                                                        # ||
    echo -e "\n\033[33mListe des fichiers différents de la première arborescence:\033[0m\n" # ||
    echo "<h3>Liste des fichiers différents de la première arborescence:</h3>
    " >> projet-bash-site.html                                                              # ||
    triedifferences Sauvegardemd5fichier1.txt                                               # ||
    echo -e "\n\033[33mListe des fichiers différents de la seconde arborescence:\033[0m\n"  # ||
    echo "<h3>Liste des fichiers différents de la seconde arborescence:</h3>
    " >> projet-bash-site.html                                                              # ||
    triedifferences Sauvegardemd5fichier2.txt                                               # ||
    echo -e "\n\033[33mListe des dossiers différents de la première arborescence:\033[0m\n" # ||
    echo "<h3>Liste des dossiers différents de la première arborescence:</h3>
    " >> projet-bash-site.html                                                              # ||
    triedifferences Sauvegardemd5dossier1.txt                                               # ||
    echo -e "\n\033[33mListe des dossiers différents de la seconde arborescence:\033[0m\n"  # ||
    echo "<h3>Liste des dossiers différents de la seconde arborescence:</h3>
    " >> projet-bash-site.html                                                              # ||
    triedifferences Sauvegardemd5dossier2.txt                                               # ||
fi                                                                                          # \/ Affiche le tri des fichiers et dossiers par leurs empreintes md5


echo -e "\n\n\n\033[33mCréation d'un fichier md5.txt...\033[0m(Cette opération peut prendre quelques minutes selon la taille de vos arborescences)"
...
echo "
                        <br><br><table>
                            ...
                            <tr><td colspan=\"2\" class=\"important\">Differences de fichiers (arbo1>arbo2)</td></tr>
    " >> projet-bash-site.html

TexteEntreCorrEtDiff 1 2 fichiers                                                        # ||
                                                                                         # ||
calculdifference TempSauvegardemd5fichier1.txt TempSauvegardemd5fichier2.txt 1  fichier  # ||
                                                                                         # ||
TexteEntreDiffEtCorr 1 2 $nombredifferencefichier1 fichiers                              # ||
                                                                                         # ||
if test $versionComplete -eq 1                                                           # ||
then                                                                                     # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Correspondances de fichiers (arbo1>arbo2)</td></tr>
    " >> projet-bash-site.html                                                           # ||
fi                                                                                       # ||
                                                                                         # ||
calculcorrespondance TempSauvegardemd5fichier1.txt TempSauvegardemd5fichier2.txt fichier # ||
                                                                                         # ||
TexteEntreCorrEtDiff 2 1 fichiers                                                        # ||
                                                                                         # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Differences de fichiers (arbo2>arbo1)</td></tr>
    " >> projet-bash-site.html                                                           # ||
                                                                                         # ||
calculdifference TempSauvegardemd5fichier2.txt TempSauvegardemd5fichier1.txt 2 fichier   # ||
                                                                                         # ||
TexteEntreDiffEtCorr 2 1 $nombredifferencefichier2 fichiers                              # ||
                                                                                         # ||
if test $versionComplete -eq 1                                                           # ||
then                                                                                     # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Correspondances de fichiers (arbo2>arbo1)</td></tr>
    " >> projet-bash-site.html                                                           # ||
fi                                                                                       # ||
                                                                                         # ||
calculcorrespondance TempSauvegardemd5fichier2.txt TempSauvegardemd5fichier1.txt fichier # ||
                                                                                         # ||
TexteEntreCorrEtDiff 1 2 dossiers                                                        # ||
                                                                                         # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Differences de dossiers (arbo1>arbo2)</td></tr>
    " >> projet-bash-site.html                                                           # ||
                                                                                         # ||
calculdifference TempSauvegardemd5dossier1.txt TempSauvegardemd5dossier2.txt 3 dossier   # ||
                                                                                         # ||
TexteEntreDiffEtCorr 1 2 $nombredifferencedossier1 dossiers                              # ||
                                                                                         # ||
if test $versionComplete -eq 1                                                           # ||
then                                                                                     # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Correspondances de dossiers (arbo1>arbo2)</td></tr>
    " >> projet-bash-site.html                                                           # ||
fi                                                                                       # ||
                                                                                         # ||
calculcorrespondance TempSauvegardemd5dossier1.txt TempSauvegardemd5dossier2.txt dossier # ||
                                                                                         # ||
TexteEntreCorrEtDiff 2 1 dossiers                                                        # ||
                                                                                         # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Differences de dossiers (arbo2>arbo1)</td></tr>
    " >> projet-bash-site.html                                                           # ||
                                                                                         # ||
calculdifference TempSauvegardemd5dossier2.txt TempSauvegardemd5dossier1.txt 4 dossier   # ||
                                                                                         # ||
TexteEntreDiffEtCorr 2 1 $nombredifferencedossier2 dossiers                              # ||
                                                                                         # ||
if test $versionComplete -eq 1                                                           # ||
then                                                                                     # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Correspondances de dossiers (arbo2>arbo1)</td></tr>
    " >> projet-bash-site.html                                                           # ||
fi                                                                                       # ||
                                                                                         # ||
...
echo -e "\n\033[31m----------------------------------------------------------------------------------------------------------\033[0m\n\n"
echo -e "\n\033[36mIl y a en tout\033[0m \033[32m$nombredifferencefichier\033[0m \033[36mfichiers différents\033[0m\n"
echo -e "\033[36mIl y a en tout\033[0m \033[32m$nombredifferencedossier\033[0m \033[36mdossiers différents\033[0m\n"

echo "
                                         </table>
                                         <br><hr><br>
                                         <h2>Il y a $nombredifferencefichier fichiers différents et $nombredifferencedossier dossiers différents</h2>
    " >> projet-bash-site.html
    
if [[ $nombredifferencefichier == 0 ]] && [[ $nombredifferencedossier == 0 ]] # ||
then                                                                          # ||
echo -e "\n\033[36mLes deux répertoires sont identiques\033[0m"               # ||
echo " <h2 class=\"rouge\">Les deux répertoires sont donc identiques</h2>
    " >> projet-bash-site.html                                                # ||
else                                                                          # ||
echo -e "\n\033[36mLes deux répertoires ne sont pas identiques\033[0m\n\n"    # ||  
echo " <h2 class=\"rouge\">Les deux répertoires sont donc différents</h2>
    " >> projet-bash-site.html                                                # ||                                
...
echo "
                            ...
                            <div id=\"footer\">
                                &copy; Copyright 2019 Eliot Masset - Maxene Ikarionen - Hugo Di Piazza - Tous droits réservés
                            </div>
                        </div>
                    </body>
                </html>
