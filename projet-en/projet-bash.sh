...
Sidossier ()
{
    if test -d $1                                                             # ||
    then                                                                      # ||
        echo -e "        \033[36m$n\033[0m\033[31m/6\033[0m successful steps" # ||
    else                                                                      # ||
        echo  -e "\033[31merror !\033[0m"                                     # ||
        echo "Directory : " $1 " does not exist or is a file"                 # ||
...
Sivide ()
{
    ...
    then                                                                      # ||
        ...
        echo  -e "\033[31merror !\033[0m"                                     # ||
        echo "Le répertoire : " $1 " is not accessible for reading"           # ||
        exit                                                                  # \/
...
{
    echo -e "\033[33mthere is therefore\033[0m\033[32m $3 \033[0m\033[33mdifferences of $4 in the directory $1 relative to the directory $2\033[0m"

    echo -e "List of $4 of the directory $1 and their correspondence in the directory $2 :" >> $md5
    echo -e "------------------------------------------------------------------------------------------\n\n" >> $md5
    if test $versionComplete -eq 1
    then
        echo -e "\033[31mList of $4 of the directory $1 and their correspondence in the directory $2 :\033[0m"
...
{
    echo -e "List of $3 of the directory $1 who have no correspondence in the directory $2 :" >> $md5
    echo -e "------------------------------------------------------------------------------------------\n\n" >> $md5
    echo -e "\033[31mList of $3 of the directory $1 who have no correspondence in the directory $2 :\033[0m"
    echo -e "\033[31m------------------------------------------------------------------------------------------\033[0m\n\n"
}
...
calculcorrespondance ()
{
    ...
    do                                                                                                                                                # ||
        ...
        do                                                                                                                                            # ||
            ...
            then                                                                                                                                      # ||
                ...
                then                                                                                                                                  # ||
                    if test $versionComplete -eq 1                                                                                                    # ||
                    then                                                                                                                              # ||
                        echo -e "\n\033[33mFile " $lignenom "has as correspondence : \033[0m\n"                                                       # ||
                        echo "
                            <tr><td class=\"rouge\" colspan=\"2\">$lignenom</td></tr>
                        " >> projet-bash-site.html                                                                                                    # ||
                    fi                                                                                                                                # ||
                    echo -e "\nDirectory " $lignenom "has as correspondence : \n" >> $md5                                                             # ||
                fi                                                                                                                                    # ||
                unefois=0                                                                                                                             # ||
        ...
        then                                                                                                                                          # ||
            if test $versionComplete -eq 1                                                                                                            # ||
            then                                                                                                                                      # ||
                echo -e "\n\033[33mfor information, it is located at the address:\033[0m $lignechemin"                                                # ||
                echo -e "\n\033[33m------------------------------------------------------------------------------------------------------\033[0m"     # ||
            fi                                                                                                                                        # ||
            echo -e "\nfor information, it is located at the address: $lignechemin" >> $md5                                                           # ||
            echo -e "\n------------------------------------------------------------------------------------------------------" >> $md5                # ||
        fi                                                                                                                                            # ||
...
calculdifference ()
{
    ...
    do                                                                                                                                                                 # ||
        ...
        echo "
            ...
            " >> projet-bash-site.html                                                                                                                                 # ||
            echo -e "\n\033[33mMd5 hash :\033[0m $lignemd5 \n\033[33mComplete path to the file : \033[0m$lignechemin \n\033[33mName of the file :\033[0m $lignenom \n" # ||
            echo -e "\nMd5 hash : $lignemd5 \nComplete path to the file : $lignechemin \nName of the file : $lignenom \n" >> $md5                                      # ||
...
do
    echo -e "\033[32mWish to the complet version of the program \033[0m\033[31m(1=YES/0=NO)\033[0m\033[32m?\033[0m"
...
do
    ...
    do
       echo -e "\033[32mWish you to change destination directory of md5.txt :\033[0m\033[33m($PWD)\033[0m\033[31m(1=yes/0=NO)?\033[0m"
       read Booldestination
    done
    if test $Booldestination -eq 1
    then
        echo -e "\033[31mWhere you wish to put md5.txt?\033[0m"
        read cheminversmd5
    fi
done
md5="md5.txt"
...
clear
    ...
    sleep 1                                                             # \/
    echo -e "\033[32m\r Go \033[0m"                                     #Décompte à rebours (optionel)
...
echo -e "\nChecking of potential \033[31merror\033[0m  ...\n\n"


if test $# -ne 2                                                            # ||                                                                         # ||
then                                                                        # ||                                                                         # ||
    echo -e "\033[32mWish to inform first directory :\033[0m"               # ||                                                                         # ||
    read arbo1                                                              # ||                                                                         # ||
    echo -e "\033[32mWish to inform seconde directory :\033[0m"             # ||                                                                         # ||
    read arbo2                                                              # ||                                                                         # ||
    echo -e "        \033[36m1\033[0m\033[31m/6\033[0m successful steps"    # ||                                                                         # ||
else                                                                        # ||                                                                         # ||
    echo -e "        \033[36m1\033[0m\033[31m/6\033[0m successful steps"    # \/                                                                         # ||
...
then                                                                                    # ||                                                             # ||
    echo -e "        \033[36m6\033[0m\033[31m/6\033[0m successful steps\n"              # ||                                                             # ||
else                                                                                    # ||                                                             # ||
    echo -e "\033[31merror ! \033[0m Directories are empty"                             # ||                                                             # ||
    exit                                                                                # \/                                                             # ||
...
echo -e "\033[32mProgram can be launch succesfull.\033[0m"
echo -e "\033[31mInformation\033[0m : The program support space touch \n" 
...
do
    ...
    arret=1
    arret=0
    echo "Reading of md5 hash of files of directory" $i
    ...
    echo "Reading of md5 hash of folders"
...
<html lang= \"fr\">
    <head>                   
        ...
        <title>Website Bash Project 2019</title>
    </head>
    
    <body>
        <div id=\"page\">
            <div id=\"header\">
                <h1>Website Bash Project 2019</h1>
                <h2>Here is our website you can find the results table below</h2>
            </div>
            <div id=\"containment\">
                <div id=\"content\">
                    <div class=\"article\">
...
if test $versionComplete -eq 1                                                              # ||
then                                                                                        # ||
    echo -e "\n\033[33mList of diffenrents files of the first directory :\033[0m\n"         # ||
    echo "<h3>List of diffenrents files of the first directory :</h3>
    " >> projet-bash-site.html                                                              # ||
    triedifferences Sauvegardemd5fichier1.txt                                               # ||
    echo -e "\n\033[33mList of diffenrents files of the second directory :\033[0m\n"        # ||
    echo "<h3>List of diffenrents files of the second directory :</h3>
    " >> projet-bash-site.html                                                              # ||
    triedifferences Sauvegardemd5fichier2.txt                                               # ||
    echo -e "\n\033[33mList of diffenrents folders of the first directory :\033[0m\n"       # ||
    echo "<h3>List of diffenrents folders of the first directory :</h3>
    " >> projet-bash-site.html                                                              # ||
    triedifferences Sauvegardemd5dossier1.txt                                               # ||
    echo -e "\n\033[33mList of diffenrents folders of the second directory :\033[0m\n"      # ||
    echo "<h3>List of diffenrents folders of the second directory :</h3>
    " >> projet-bash-site.html                                                              # ||
    triedifferences Sauvegardemd5dossier2.txt                                               # ||
fi                                                                                          # \/ Affiche le trie des fichiers et dossiers par leurs empreintes md5


echo -e "\n\n\n\033[33mCreation of a file md5.txt...\033[0m(This operation can take few minutes according to file size)"
...
echo "
                        <br><br><table>
                            ...
                            <tr><td colspan=\"2\" class=\"important\">File differences (tree1>tree2)</td></tr>
    " >> projet-bash-site.html

TexteEntreCorrEtDiff 1 2 files                                                    # ||
                                                                                  # ||
calculdifference TempSauvegardemd5fichier1.txt TempSauvegardemd5fichier2.txt 1    # ||
                                                                                  # ||
TexteEntreDiffEtCorr 1 2 $nombredifferencefichier1 files                          # ||
                                                                                  # ||
if test $versionComplete -eq 1                                                    # ||
then                                                                              # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">File matches (tree1>tree2)</td></tr>
    " >> projet-bash-site.html                                                    # ||
fi                                                                                # ||
                                                                                  # ||
calculcorrespondance TempSauvegardemd5fichier1.txt TempSauvegardemd5fichier2.txt  # ||
                                                                                  # ||
TexteEntreCorrEtDiff 2 1 files                                                    # ||
                                                                                  # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">File differences (tree2>tree1)</td></tr>
    " >> projet-bash-site.html                                                    # ||
                                                                                  # ||
calculdifference TempSauvegardemd5fichier2.txt TempSauvegardemd5fichier1.txt 2    # ||
                                                                                  # ||
TexteEntreDiffEtCorr 2 1 $nombredifferencefichier2 files                          # ||
if test $versionComplete -eq 1                                                    # ||
then                                                                              # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">File matches (tree2>tree1)</td></tr>
    " >> projet-bash-site.html                                                    # ||
fi                                                                                # ||
                                                                                  # ||
calculcorrespondance TempSauvegardemd5fichier2.txt TempSauvegardemd5fichier1.txt  # ||
                                                                                  # ||
TexteEntreCorrEtDiff 1 2 folders                                                  # ||
                                                                                  # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Records differences (tree1>tree2)</td></tr>
    " >> projet-bash-site.html                                                    # ||
                                                                                  # ||
calculdifference TempSauvegardemd5dossier1.txt TempSauvegardemd5dossier2.txt 3    # ||
                                                                                  # ||
TexteEntreDiffEtCorr 1 2 $nombredifferencedossier1 folders                        # ||
if test $versionComplete -eq 1                                                    # ||
then                                                                              # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Records matches (tree1>tree2)</td></tr>
    " >> projet-bash-site.html                                                    # ||
fi                                                                                # ||
                                                                                  # ||
calculcorrespondance TempSauvegardemd5dossier1.txt TempSauvegardemd5dossier2.txt  # ||
                                                                                  # ||
TexteEntreCorrEtDiff 2 1 folders                                                  # ||
                                                                                  # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Records differences (tree2>tree1)</td></tr>
    " >> projet-bash-site.html                                                    # ||
                                                                                  # ||
calculdifference TempSauvegardemd5dossier2.txt TempSauvegardemd5dossier1.txt 4    # ||
                                                                                  # ||
TexteEntreDiffEtCorr 2 1 $nombredifferencedossier2 folders                        # ||
if test $versionComplete -eq 1                                                    # ||
then                                                                              # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Records matches (tree2>tree1)</td></tr>
    " >> projet-bash-site.html                                                    # ||
fi                                                                                # ||
                                                                                  # ||
...
echo -e "\n\033[31m----------------------------------------------------------------------------------------------------------\033[0m\n\n"
echo -e "\n\033[36mThere are a total of\033[0m \033[32m$nombredifferencefichier\033[0m \033[36mdifferents files\033[0m\n"
echo -e "\033[36mThere are a total of\033[0m \033[32m$nombredifferencedossier\033[0m \033[36mdifferents folders\033[0m\n"

echo "
                                         </table>
                                         <br><hr><br>
                                         <h2>There is $nombredifferencefichier Files differences and $nombredifferencedossier records differences</h2>
    " >> projet-bash-site.html

if [[ $nombredifferencefichier == 0 ]] && [[ $nombredifferencedossier == 0 ]] # ||
then                                                                          # ||
echo -e "\n\033[36mTwo directory are identical\033[0m"                        # ||
echo " <h2 class=\"rouge\">Two directory are therefore identical</h2>
    " >> projet-bash-site.html                                                # ||
else                                                                          # ||
echo -e "\n\033[36mTwo directory are different\033[0m\n\n"                    # ||
echo " <h2 class=\"rouge\">Two directory are therefore different</h2>
    " >> projet-bash-site.html                                                # ||
...
echo "
                            ...
                            <div id=\"footer\">
                                &copy; Copyright 2019 Eliot Masset - Maxene Ikarionen - Hugo Di Piazza - All rights reserved
                            </div>
                        </div>
                    </body>
                </html>
