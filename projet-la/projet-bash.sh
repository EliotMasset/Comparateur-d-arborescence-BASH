...
Sidossier ()
{
    if test -d $1                                                            # ||
    then                                                                     # ||
        echo -e "        \033[36m$n\033[0m\033[31m/6\033[0m bene gradus"     # ||
    else                                                                     # ||
        echo  -e "\033[31merror !\033[0m"                                    # ||
        echo "Aliquam : " $1 " non existit, aut est file"                    # ||
...
{
    echo -e "\033[33mIta est\033[0m\033[32m $3 \033[0m\033[33mdifferentiae $4 in ligno $1 comparatur ad arborem $2\033[0m"

    echo -e "Album $4 arbor $1 et eorum matches in ligno $2 :" >> $md5
    echo -e "------------------------------------------------------------------------------------------\n\n" >> $md5
    if test $versionComplete -eq 1
    then
        echo -e "\033[31mAlbum $4 arbo $1 et eorum matches in ligno $2 :\033[0m"
...
{
    echo -e "Album $3 arbo $1 quae non par in ligno $2 :" >> $md5
    echo -e "------------------------------------------------------------------------------------------\n\n" >> $md5
    echo -e "\033[31mAlbum $3 arbo $1 quae non par in ligno $2 :\033[0m"
    echo -e "\033[31m------------------------------------------------------------------------------------------\033[0m\n\n"
}
...
calculcorrespondance ()
{
    ...
    do                                                                                                                                                # ||
        ...
        do                                                                                                                                            # ||
            ...
            then                                                                                                                                      # ||
                ...
                then                                                                                                                                  # ||
                    if test $versionComplete -eq 1                                                                                                    # ||
                    then                                                                                                                              # ||
                        echo -e "\n\033[33mFile" $lignenom "ut correspondentia : \033[0m\n"                                                           # ||
                        echo "
                            <tr><td class=\"rouge\" colspan=\"2\">$lignenom</td></tr>
                        " >> projet-bash-site.html                                                                                                    # ||
                    fi                                                                                                                                # ||
                    echo -e "\nRecord" $lignenom "ut correspondentia : \n" >> $md5                                                                    # ||
                fi                                                                                                                                    # ||
                unefois=0                                                                                                                             # ||
        ...
        then                                                                                                                                          # ||
            if test $versionComplete -eq 1                                                                                                            # ||
            then                                                                                                                                      # ||
                echo -e "\n\033[33mPro Notitia, sita est ad:\033[0m $lignechemin"                                                                     # ||
                echo -e "\n\033[33m------------------------------------------------------------------------------------------------------\033[0m"     # ||
            fi                                                                                                                                        # ||
            echo -e "\nPro Notitia, sita est ad: $lignechemin" >> $md5                                                                                # ||
            echo -e "\n------------------------------------------------------------------------------------------------------" >> $md5                # ||
        fi                                                                                                                                            # ||
...
calculdifference ()
{
    ...
    do                                                                                                                                                                 # ||
        ...
        echo "
            ...
            " >> projet-bash-site.html                                                                                                                                 # ||
            echo -e "\n\033[33mmd5 fingerprint:\033[0m $lignemd5 \n\033[33mTotam viam file: \033[0m$lignechemin \n\033[33mFile name:\033[0m $lignenom \n"              # ||
            echo -e "\nmd5 fingerprint: $lignemd5 \nTotam viam file: $lignechemin \nFile name: $lignenom \n" >> $md5                                                   # ||
...
do
    echo -e "\033[32mVis Plenus poema poematis of a progressio\033[0m\033[31m(1=Etiam/0=Nulla)\033[0m\033[32m?\033[0m"
...
do
    ...
    do
       echo -e "\033[32mSimilis mutatio destinatum directorium md5.txt :\033[0m\033[33m($PWD)\033[0m\033[31m(1=Etiam/0=Nulla)?\033[0m"
       read Booldestination
    done
    if test $Booldestination -eq 1
    then
        echo -e "\033[31mUbi uolunt md5.txt?\033[0m"
        read cheminversmd5
    fi
done
md5="md5.txt"
...
echo -e "\nReprehendo \033[31merrors\033[0m fieri potest...\n\n"


if test $# -ne 2                                                            # ||                                                                         # ||
then                                                                        # ||                                                                         # ||
    echo -e "\033[32mCommodo consequat in prima arbore :\033[0m"            # ||                                                                         # ||
    read arbo1                                                              # ||                                                                         # ||
    echo -e "\033[32mCommodo consequat in secunda arbor :\033[0m"           # ||                                                                         # ||
    read arbo2                                                              # ||                                                                         # ||
    echo -e "        \033[36m1\033[0m\033[31m/6\033[0m bene gradus"         # ||                                                                         # ||
else                                                                        # ||                                                                         # ||
    echo -e "        \033[36m1\033[0m\033[31m/6\033[0m bene gradus"         # \/                                                                         # ||
...
then                                                                                    # ||                                                             # ||
    echo -e "        \033[36m6\033[0m\033[31m/6\033[0m bene gradus\n"                   # ||                                                             # ||
else                                                                                    # ||                                                             # ||
    echo -e "\033[31mError ! \033[0m Inanis arbores inutiles sunt"                      # ||                                                             # ||
    exit                                                                                # \/                                                             # ||
...
echo -e "\033[32mProgressio potest esse coepi recte.\033[0m"
echo -e "\033[31mInformation\033[0m : Progressio sustinet spatia\n" 
...
do
    ...
    arret=1
    arret=0
    echo "Lectio md5 fingerprints ex arbo lima " $i
    ...
    echo "Lectio md5 fingerprints a lima"
...
<html lang= \"fr\">
    <head>                   
        ...
        <title>Website Project Bash MMXIX</title>
    </head>
    
    <body>
        <div id=\"page\">
            <div id=\"header\">
                <h1>Website Project Bash MMXIX</h1>
                <h2>Hic est nostrum website vos can reperio a mensa proventus infra positi referuntur</h2>
            </div>
            <div id=\"containment\">
                <div id=\"content\">
                    <div class=\"article\">
...
if test $versionComplete -eq 1                                                              # ||
then                                                                                        # ||
    echo -e "\n\033[33mIndex alia quae prima arbore:\033[0m\n"                              # ||
    echo "<h3>Index alia quae prima arbore:</h3>
    " >> projet-bash-site.html                                                              # ||
    triedifferences Sauvegardemd5fichier1.txt                                               # ||
    echo -e "\n\033[33mIndex alia quae seconda arbore:\033[0m\n"                            # ||
    echo "<h3>Index alia quae seconda arbore:</h3>
    " >> projet-bash-site.html                                                              # ||
    triedifferences Sauvegardemd5fichier2.txt                                               # ||
    echo -e "\n\033[33mIndex diversis folders prima arbore:\033[0m\n"                       # ||
    echo "<h3>Index diversis folders prima arbore:</h3>
    " >> projet-bash-site.html                                                              # ||
    triedifferences Sauvegardemd5dossier1.txt                                               # ||
    echo -e "\n\033[33mIndex diversis folders secunda arbore:\033[0m\n"                     # ||
    echo "<h3>Index diversis folders seconda arbore:</h3>
    " >> projet-bash-site.html                                                              # ||
    triedifferences Sauvegardemd5dossier2.txt                                               # ||
fi                                                                                          # \/ Affiche le trie des fichiers et dossiers par leurs empreintes md5


echo -e "\n\n\n\033[33mPartum a lima md5.txt...\033[0m(Licet secundum hanc mensuram paulo arbor)"
...
echo "
                        <br><br><table>
                            ...
                            <tr><td colspan=\"2\" class=\"important\">differences files (lignum1>lignum2)</td></tr>
    " >> projet-bash-site.html
...
then                                                                              # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">file Mappings (lignum1>lignum2)</td></tr>
    " >> projet-bash-site.html                                                    # ||
fi                                                                                # ||
                                                                                  # ||
...
TexteEntreCorrEtDiff 2 1 files                                                    # ||
                                                                                  # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">differences files (lignum2>lignum1)</td></tr>
    " >> projet-bash-site.html                                                    # ||
                                                                                  # ||
...
then                                                                              # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">file Mappings (lignum2>lignum1)</td></tr>
    " >> projet-bash-site.html                                                    # ||
fi                                                                                # ||
                                                                                  # ||
calculcorrespondance TempSauvegardemd5fichier2.txt TempSauvegardemd5fichier1.txt  # ||
                                                                                  # ||
TexteEntreCorrEtDiff 1 2 records                                                  # ||
                                                                                  # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">differences records (lignum1>lignum2)</td></tr>
    " >> projet-bash-site.html                                                    # ||
                                                                                  # ||
calculdifference TempSauvegardemd5dossier1.txt TempSauvegardemd5dossier2.txt 3    # ||
                                                                                  # ||
TexteEntreDiffEtCorr 1 2 $nombredifferencedossier1 records                        # ||
if test $versionComplete -eq 1                                                    # ||
then                                                                              # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Matches records (lignum1>lignum2)</td></tr>
    " >> projet-bash-site.html                                                    # ||
fi                                                                                # ||
                                                                                  # ||
calculcorrespondance TempSauvegardemd5dossier1.txt TempSauvegardemd5dossier2.txt  # ||
                                                                                  # ||
TexteEntreCorrEtDiff 2 1 records                                                  # ||
                                                                                  # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">differences records (lignum2>lignum1)</td></tr>
    " >> projet-bash-site.html                                                    # ||
                                                                                  # ||
calculdifference TempSauvegardemd5dossier2.txt TempSauvegardemd5dossier1.txt 4    # ||
                                                                                  # ||
TexteEntreDiffEtCorr 2 1 $nombredifferencedossier2 records                        # ||
                                                                                  # ||
if test $versionComplete -eq 1                                                    # ||
then                                                                              # ||
echo "
                            <tr><td colspan=\"2\" class=\"important\">Matches records (lignum2>lignum1))</td></tr>
    " >> projet-bash-site.html                                                    # ||
fi                                                                                # ||
                                                                                  # ||
...
echo -e "\n\033[31m----------------------------------------------------------------------------------------------------------\033[0m\n\n"
echo -e "\n\033[36mSunt summa\033[0m \033[32m$nombredifferencefichier\033[0m \033[36malia file\033[0m\n"
echo -e "\033[36mSunt summa\033[0m \033[32m$nombredifferencedossier\033[0m \033[36malia records\033[0m\n"

echo "
                                         </table>
                                         <br><hr><br>
                                         <h2>Ante $nombredifferencefichier et variis files $nombredifferencedossier alia folders</h2>
    " >> projet-bash-site.html

if [[ $nombredifferencefichier == 0 ]] && [[ $nombredifferencedossier == 0 ]] # ||
then                                                                          # ||
echo -e "\n\033[36mDuo es identical Directory\033[0m"                         # ||
echo " <h2 class=\"rouge\">Duo es identical Directory</h2>
    " >> projet-bash-site.html                                                # ||
else                                                                          # ||
echo -e "\n\033[36mEt sic non est idem Directory\033[0m\n\n"                  # ||
echo " <h2 class=\"rouge\">Et sic non est idem Directory</h2>
    " >> projet-bash-site.html                                                # ||
...
echo "
                            ...
                            <div id=\"footer\">
                                &copy; Copyright 2019 Eliot Masset - Maxene Ikarionen - Hugo Di Piazza - Iure reservata
                            </div>
                        </div>
                    </body>
                </html>
